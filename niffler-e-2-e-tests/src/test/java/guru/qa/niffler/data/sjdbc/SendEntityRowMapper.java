...
public class SendEntityRowMapper implements RowMapper<SpendEntity> {

	public static final SendEntityRowMapper instance = new SendEntityRowMapper();

	private SendEntityRowMapper() {
